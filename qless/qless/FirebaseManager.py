...
class FirebaseManager:
	...
	def get_walk_in_queue(self):
		return self.firebase.get('queues/0/walk_in', '')
	...
	def add_scheduled_user(self, user_id, name, doctor_index, doctor_name, scheduled_start_time):
	...
	def add_walk_in_user(self, user_id, name, current_time, predicted_start_time):
		data = {
			'id': user_id,
