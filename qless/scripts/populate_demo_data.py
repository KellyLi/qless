...
def populate_scheduled_users():
	...
	queueManager.add_scheduled_user(0, "K. Malone", "doctor_hudson", (time - hour))
	queueManager.add_scheduled_user(1, "P. Beesley", "doctor_hudson", (time + half_hour))
	...
	queueManager.add_scheduled_user(5, "H. Jeesley", "doctor_martin", (time + half_hour))
	queueManager.add_scheduled_user(6, "K. Lalone", "doctor_martin", (time + 1*hour))
	queueManager.add_scheduled_user(7, "M. Neesley", "doctor_martin", (time + 1.5*hour))
